...
export const IconLogo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" className={className}>
    <defs>
      <linearGradient id="tealGrad" x1="0" y1="0" x2="40" y2="40">
        <stop offset="0%" stopColor="#0d9488" />
        <stop offset="100%" stopColor="#115e59" />
      </linearGradient>
    </defs>
    <path d="M8 32V20C8 13.3726 13.3726 8 20 8C26.6274 8 32 13.3726 32 20V32" stroke="url(#tealGrad)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M20 8V12" stroke="#f97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="20" cy="8" r="3" fill="#f97316"/>
    <path d="M4 32H36" stroke="url(#tealGrad)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
